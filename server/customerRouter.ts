    ...
    .mutation(async ({ input }) => {
      if (!isEmailConfigured()) {
        throw new TRPCError({
          ...
          message: "Account creation is temporarily unavailable while email verification is being reauthorized.",
        });
      }
      try {
  ...
  resendVerification: publicProcedure
    ...
    .mutation(async ({ input }) => {
      if (!isEmailConfigured()) {
        throw new TRPCError({
          code: "PRECONDITION_FAILED",
          message: "Verification email is temporarily unavailable while email delivery is being reauthorized.",
        });
      }
  ...
  forgotPassword: publicProcedure
    ...
    .mutation(async ({ input }) => {
      if (!isEmailConfigured()) {
        throw new TRPCError({
          code: "PRECONDITION_FAILED",
          message: "Password recovery is temporarily unavailable while email delivery is being reauthorized.",
        });
      }
