...
- [ ] Save the owner-approved combined Shop metrics, cart, checkout, Zelle confirmation, My Account, Order History, and brand-proof readability checkpoint, which automatically publishes the validated update.
- [ ] Verify the live custom and Manus domains for the Shop metric strip, real authenticated cart/checkout/account routes, protected prices, `$7` shipping, tax and Zelle constants, both exact brand proof lines, representative COAs, and non-secret integration status without placing another order.
- [ ] Report the published version and confirm customer/order data, catalog, prices, COAs, integrations, and domains remained protected.
