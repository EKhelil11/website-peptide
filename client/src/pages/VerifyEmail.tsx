    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        >
          ...
          {status === "loading" && (
            <>
              <Loader2 size={48} className="mx-auto mb-4 animate-spin" style={{ color: "oklch(0.76 0.02 250)" }} />
              <h2 className="text-white mb-2" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.8rem", letterSpacing: "0.06em" }}>
                VERIFYING EMAIL
              </h2>
          ...
          {status === "error" && (
            <>
              ...
              <button
                ...
                className="w-full py-3 rounded-xl font-bold tracking-wider uppercase text-sm transition-all duration-200 active:scale-[0.98]"
                style={{
                  background: "oklch(0.76 0.02 250 / 0.15)",
                  border: "1px solid oklch(0.76 0.02 250 / 0.3)",
