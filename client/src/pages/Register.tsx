    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-md text-center">
          <Link href="/">
            <img src={PRIMARY_LOGO_URL} alt={PRIMARY_LOGO_ALT} className={`${AUTH_LOGO_SIZE_CLASS} mx-auto mb-8 cursor-pointer`} />
          </Link>
          <div
            className="rounded-2xl p-10 border"
            style={{
              background: "oklch(0.22 0.065 255 / 0.95)",
              borderColor: "oklch(0.76 0.02 250 / 0.3)",
              boxShadow: "0 0 60px oklch(0.76 0.02 250 / 0.08)",
            }}
          >
            <div
              className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6"
              style={{ background: "oklch(0.76 0.02 250 / 0.15)", border: "1px solid oklch(0.76 0.02 250 / 0.3)" }}
            >
              <Mail size={28} style={{ color: "oklch(0.76 0.02 250)" }} />
            </div>
            <h2
            ...
            <p className="mb-6 text-sm font-semibold" style={{ color: "oklch(0.76 0.02 250)", fontFamily: "'Rajdhani', sans-serif" }}>
              {form.email}
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-white/8">
              <p className="text-white/35 text-xs" style={{ fontFamily: "'Inter', sans-serif" }}>
                ...
                <button
                  ...
                  style={{ color: "oklch(0.76 0.02 250)" }}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          <div className="mb-7">
            <h1 className="text-white mb-1" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2rem", letterSpacing: "0.06em" }}>
              CREATE ACCOUNT
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div
              ...
              style={{ background: "oklch(0.76 0.02 250 / 0.06)", border: "1px solid oklch(0.76 0.02 250 / 0.12)" }}
            >
              <ShieldCheck size={14} className="flex-shrink-0 mt-0.5" style={{ color: "oklch(0.76 0.02 250)" }} />
            ...
            <button
              ...
              style={{
                background: registerMutation.isPending
                  ? "oklch(0.76 0.02 250 / 0.5)"
                  : "linear-gradient(135deg, oklch(0.76 0.02 250), oklch(0.62 0.02 250))",
                color: "oklch(0.15 0.045 255)",
                fontFamily: "'Rajdhani', sans-serif",
                fontWeight: 700,
                boxShadow: registerMutation.isPending ? "none" : "0 0 24px oklch(0.76 0.02 250 / 0.3)",
              }}
            >
          ...
          <div className="mt-6 pt-5 border-t border-white/8 text-center">
            <p className="text-white/35 text-xs" style={{ fontFamily: "'Inter', sans-serif" }}>
              ...
              <Link href="/login">
                <span className="hover:underline cursor-pointer transition-colors" style={{ color: "oklch(0.76 0.02 250)" }}>
                  Sign in
                </span>
              </Link>
            </p>
