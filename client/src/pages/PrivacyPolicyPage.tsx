        ...
        <div style={{ fontFamily: "'Inter', sans-serif", color: "oklch(0.82 0.025 100)" }}>
          ...
          <PolicySection title="11. Contact Information">
            ...
            <p>
              ...
              <br />
              🌐 <a href="https://laelitepeps.com" className="text-[#B9C0CA] hover:underline">laelitepeps.com</a>
            </p>
          </PolicySection>
        </div>
      </main>
