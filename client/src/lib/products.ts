...
export const products: Product[] = [
  ...
  },
  {
    ...
    plainEnglish:
      "The Glow Stack is a triple-compound research protocol combining three extensively studied peptides. GHK-Cu is a naturally occurring copper-binding tripeptide with well-documented gene expression modulation properties. BPC-157 is a cytoprotective peptide derived from gastric juice with broad tissue repair signaling activity. TB-500 is a synthetic Thymosin Beta-4 fragment studied for angiogenesis and cell migration. Together, they form a comprehensive research tool for multi-pathway tissue biology investigations.",
    howItWorks:
